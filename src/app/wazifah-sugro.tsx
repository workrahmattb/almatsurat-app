...
export default function WazifahSugroScreen() {
  ...
  return (
    ...
    >
      {/* Header Banner */}
      <View style={[styles.header, { backgroundColor: 'rgba(26,92,46,0.92)', borderBottomColor: 'rgba(255,255,255,0.08)', borderBottomWidth: 1 }]}>
      ...
      {wazifah.sections.map((section) => (
        <View key={section.section_number} style={[styles.sectionCard, { backgroundColor: colors.backgroundElement, borderColor: colors.glassBorder, borderWidth: 1, shadowColor: colors.glassShadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 1, shadowRadius: 12, elevation: 6 }]}>
          <View style={styles.sectionHeader}>
            <View style={[styles.sectionNumber, { backgroundColor: '#1a5c2e', shadowColor: '#1a5c2e', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.6, shadowRadius: 8, elevation: 8 }]}>
